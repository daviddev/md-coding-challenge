...
Hello and welcome to the MD Coding Challenge. Thank you for your interest in becoming part of our team. The purpose of this challenge is to give you a feeling for the tasks that await you at MD and to familiarize you with our current stack.
...
- Create a database, name it 'md_coding_challenge'.
- Setup .env file
...
- Write a mail to david@mdsystems.am containing a link to a repository with your code.
